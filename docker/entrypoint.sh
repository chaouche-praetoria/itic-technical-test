...
chown -R laravel:www-data storage bootstrap/cache public/build
...
if [ "$ROLE" = "app" ]; then
    ...
    if [ "$APP_ENV" != "local" ]; then
        ...
        rsync -rlD --delete public_assets/build/ public/build/
        chown -R laravel:www-data public/build
